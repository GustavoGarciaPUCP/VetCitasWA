...
namespace VetCitasWA.Servicios.REST.CitaRS
{
    public class RecordatorioRestService
    {
        ...
        {
            return http.GetFromJsonAsync<List<Recordatorio>>("RecordatorioRS/listarTodos")
        ...
        {
            return http.GetFromJsonAsync<Recordatorio>($"RecordatorioRS/buscarPorId/{id}")
        ...
        public List<Recordatorio> ListarPorMascotaOCliente(string texto)
        {
            ...
            return http.GetFromJsonAsync<List<Recordatorio>>($"RecordatorioRS/listarPorMascotaCliente/{busqueda}")
                .GetAwaiter().GetResult() ?? new List<Recordatorio>();
        }
        ...
        public List<Recordatorio> ListarPorEstadoYFecha(string estado, DateTime? fecha)
        {
            ...
            return http.GetFromJsonAsync<List<Recordatorio>>($"RecordatorioRS/listarPorEstadoFecha/{est}/{fechaStr}")
                .GetAwaiter().GetResult() ?? new List<Recordatorio>();
        }
        ...
        {
            return http.GetFromJsonAsync<int>("RecordatorioRS/contarPendientes")
                .GetAwaiter().GetResult();
        }
    }
}
