...
namespace VetCitasWA.Servicios.REST.CitaRS
{
    public class CitaRestService
    {
        ...
        {
            var response = http.PostAsJsonAsync("webresources/CitaRS/insertar", cita).GetAwaiter().GetResult();
        ...
        {
            var response = http.PutAsJsonAsync("webresources/CitaRS/modificar", cita).GetAwaiter().GetResult();
            return response.Content.ReadFromJsonAsync<int>().GetAwaiter().GetResult();
        }
        ...
        {
            var response = http.DeleteAsync($"webresources/CitaRS/eliminar/{idCita}").GetAwaiter().GetResult();
            return response.Content.ReadFromJsonAsync<int>().GetAwaiter().GetResult();
        }
        ...
        {
            return http.GetFromJsonAsync<List<Cita>>("webresources/CitaRS/listarTodas")
        ...
        {
            return http.GetFromJsonAsync<Cita>($"webresources/CitaRS/obtenerPorId/{idCita}")
        ...
        public int Reprogramar(int idCita, DateTime fechaInicio, DateTime fechaFin, string motivo, int modifiedBy)
        {
            ...
            var response = http.PutAsync($"webresources/CitaRS/reprogramar/{idCita}/{inicioStr}/{finStr}/{mot}/{modifiedBy}", null).GetAwaiter().GetResult();
            return response.Content.ReadFromJsonAsync<int>().GetAwaiter().GetResult();
        }
        ...
        {
            var response = http.PutAsync($"webresources/CitaRS/cambiarVeterinario/{idCita}/{idNuevoVeterinario}/{modifiedBy}", null).GetAwaiter().GetResult();
            return response.Content.ReadFromJsonAsync<int>().GetAwaiter().GetResult();
        }
        ...
        public bool ValidarDisponibilidadSlot(int idVeterinario, DateTime fechaInicio, DateTime fechaFin)
        {
            ...
            return http.GetFromJsonAsync<bool>($"webresources/CitaRS/validarDisponibilidad/{idVeterinario}/{inicioStr}/{finStr}")
                .GetAwaiter().GetResult();
        }
        ...
        public int ContarPorEstadoEnRango(string estado, DateTime desde, DateTime hasta)
        {
            ...
            return http.GetFromJsonAsync<int>($"webresources/CitaRS/contarPorEstado/{est}/{desdeStr}/{hastaStr}")
                .GetAwaiter().GetResult();
        }
        ...
        public int ContarPorVeterinarioEnRango(int idVeterinario, DateTime desde, DateTime hasta)
        {
            ...
            return http.GetFromJsonAsync<int>($"webresources/CitaRS/contarPorVeterinario/{idVeterinario}/{desdeStr}/{hastaStr}")
                .GetAwaiter().GetResult();
        }
        ...
        {
            string mot = string.IsNullOrWhiteSpace(motivo) ? "null" : motivo.Trim();
            var response = http.PutAsync($"webresources/CitaRS/cancelar/{idCita}/{mot}/{modifiedBy}", null).GetAwaiter().GetResult();
            return response.Content.ReadFromJsonAsync<int>().GetAwaiter().GetResult();
        }
        ...
        {
            var response = http.PutAsync($"webresources/CitaRS/confirmar/{idCita}/{modifiedBy}", null).GetAwaiter().GetResult();
            return response.Content.ReadFromJsonAsync<int>().GetAwaiter().GetResult();
        }
        ...
        {
            var response = http.PutAsync($"webresources/CitaRS/marcarEnConsulta/{idCita}/{idUsuario}", null).GetAwaiter().GetResult();
            return response.Content.ReadFromJsonAsync<int>().GetAwaiter().GetResult();
        }
        ...
        {
            var response = http.PutAsync($"webresources/CitaRS/marcarAtendida/{idCita}/{modifiedBy}", null).GetAwaiter().GetResult();
            return response.Content.ReadFromJsonAsync<int>().GetAwaiter().GetResult();
        }
        ...
        {
            var response = http.PutAsync($"webresources/CitaRS/marcarNoAsistio/{idCita}/{modifiedBy}", null).GetAwaiter().GetResult();
            return response.Content.ReadFromJsonAsync<int>().GetAwaiter().GetResult();
        }
        ...
        public List<Cita> ListarPorVeterinarioYFecha(int idVeterinario, DateTime fecha)
        {
            ...
            return http.GetFromJsonAsync<List<Cita>>($"webresources/CitaRS/listarPorVeterinarioFecha/{idVeterinario}/{fechaStr}")
                .GetAwaiter().GetResult() ?? new List<Cita>();
        }
        ...
        public List<Cita> ListarFiltradas(int idVeterinario, DateTime? fechaInicio, DateTime? fechaFin, string estado, string textoBusqueda)
        {
            ...
            string url = $"webresources/CitaRS/filtrar/{idVet}/{inicioStr}/{finStr}/{est}/{texto}";
