...
namespace VetCitasWA.Servicios.REST.ClienteRS
{
    public class ClienteRestService
    {
        ...
        {
            var response = http.PostAsJsonAsync("ClienteRS/insertar", cliente).GetAwaiter().GetResult();
        ...
        {
            var response = http.DeleteAsync($"ClienteRS/eliminar/{id}").GetAwaiter().GetResult();
            return response.Content.ReadFromJsonAsync<int>().GetAwaiter().GetResult();
        }

        public int Eliminar(int id, int modifiedBy)
        {
            var response = http.DeleteAsync($"ClienteRS/eliminar/{id}/{modifiedBy}").GetAwaiter().GetResult();
            return response.Content.ReadFromJsonAsync<int>().GetAwaiter().GetResult();
        }
        ...
        {
            return http.GetFromJsonAsync<List<Cliente>>("ClienteRS/listarTodos")
        ...
        {
            return http.GetFromJsonAsync<Cliente>($"ClienteRS/buscarPorId/{id}")
        ...
        public List<Cliente> ListarPorNombreApellidoODni(string texto)
        {
            ...
            return http.GetFromJsonAsync<List<Cliente>>($"ClienteRS/buscarPorTexto/{busqueda}")
                .GetAwaiter().GetResult() ?? new List<Cliente>();
        }
        ...
        {
            return http.GetFromJsonAsync<int>("ClienteRS/contarActivos")
                .GetAwaiter().GetResult();
        }
        ...
        {
            return http.GetFromJsonAsync<int>($"ClienteRS/contarNuevos/{anio}/{mes}")
                .GetAwaiter().GetResult();
        }
    }
}
